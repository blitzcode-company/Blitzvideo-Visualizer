...
import { ModalReporteComentarioComponent } from '../../modales/modal-reporte-comentario/modal-reporte-comentario.component';
...
export class ComentariosComponent implements OnInit {
  ...
  @Output() totalComentariosChange = new EventEmitter<number>();
    ...
    this.comentariosService.traerComentariosDelVideo(this.videoId, this.usuario?.id)
      .subscribe({
        next: (res: any[]) => {
          ...
          this.totalComentariosChange.emit(this.totalComentarios);
        },
        error: (err) => {
